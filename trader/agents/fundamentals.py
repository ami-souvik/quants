...
class FundamentalsAgent(BaseAgent):
    ...
    def model(self) -> str:  # type: ignore[override]
        return self.settings.agent_model_fundamentals
    ...
    def run(
        ...
        logger.info(
            ...
            ticker,
            fii_dii_flows.get("fii_net_buy_cr") or 0.0,
            fii_dii_flows.get("dii_net_buy_cr") or 0.0,
            macro_context.get("nifty_1d_pct") or 0.0,
            macro_context.get("usd_inr") or 0.0,
            known_fundamentals.get("pe_ratio") or "N/A",
            known_fundamentals.get("pb_ratio") or "N/A",
            known_fundamentals.get("roe") or "N/A",
        )

        def call_fn():
            return self._call_model(user_message, response_model=FundamentalsOutput)
